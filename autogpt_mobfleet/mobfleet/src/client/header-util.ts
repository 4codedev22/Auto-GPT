...
const applicationName = config.get('mobfleet.clientApp.name');
...
export class HeaderUtil {
    ...
    static addConfigsUpdatedAtHeader(res: Response, updatedAt: Date | null) {
        if (updatedAt != null) res.set('ConfigsUpdatedAt', updatedAt.toISOString());
    }
