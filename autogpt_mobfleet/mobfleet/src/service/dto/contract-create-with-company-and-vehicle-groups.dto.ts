 ...
 */
export class ContractCreateWithCompanyAndVehicleGroupsDTO extends BaseDTO {
  @IsNotEmpty()
  @MaxLength(255)
  ...
  @ApiModelProperty({ description: 'vehicleGroups relationship' })
  vehicleGroups: string[];

  @ApiModelProperty({ description: 'clientToken relationship' })
  clientToken: string;

  @ApiModelProperty({ description: 'secretToken relationship' })
  secretToken: string;
}
